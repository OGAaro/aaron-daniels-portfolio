...
export const projects = [
  ...
  },
  {
    ...
    year: '2021 — 2023',
    summary: 'End-to-end replacement of a legacy Technology Transfer platform (Wellspring Sophia) with a custom-built Salesforce org, supporting invention, patent, and licensing operations across the Rice research community.',
    highlights: [
      ...
      'Integrated Salesforce with USPTO, EPO, and HCM systems for automated data enrichment across IP records.',
    ...
    image: null,
    links: [],
    impact: '18 internal staff + 500+ Rice community users on a unified platform',
  },
  {
